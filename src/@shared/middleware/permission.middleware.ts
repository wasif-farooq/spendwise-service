...
export const requirePermission = (permission: string) => {
    return async (req: Request, res: Response, next: NextFunction) => {
        ...
        // Check multiple param names for workspace ID (order matters - check workspaceId first)
        const workspaceId = req.params.workspaceId || req.params.id || req.params.orgId;
